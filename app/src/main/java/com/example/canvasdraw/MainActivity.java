...
public class MainActivity extends AppCompatActivity {
    ...
    private void drawSomething(View view) {
        ...
        Point faceE = new Point(halfWidth-240, halfHeight-180);
        Point faceD = new Point(halfWidth+240, halfHeight+320);
        Point faceC = new Point(halfWidth+20, halfHeight+320);
        ...
        switch (frameCount) {
            case 0:
                ...
                path.lineTo(faceA.x, faceA.y);
                path.lineTo(faceD.x, faceD.y);
                path.lineTo(faceE.x, faceE.y);
                path.close();
